    ...
    <div class="flex flex-col border-0 w-[95%] mx-auto">
        ...
        <section class="flex flex-col w-full md:w-full py-8 px-2 md:px-4 border-0 border-red-900 mx-auto border border-1">
            ...
            <div class="flex border-b border-gray-300 py-2 justify-between">
                    <div>
                        <h1 class="text-2xl font-semibold font-serif text-gray-800">Results</h1>
                    </div>
                    <div>
                    ...
                    <table class="table-auto border-collapse border border-1 border-gray-200 w-full">
                        <thead>
                            <tr class="bg-gray-200">
                                ...
                                <th width='10%' class="font-semibold py-2 text-left">Result</th> 
                        ...
                        <tbody>
                            ...
                            <tr class="border border-b border-gray-200 ">
                                ...
                                <td>
                                          <a href="{{ route('admin.results.elections.show', ['election' => $election->id]) }}" class='hover:underline'> 
                                                 {{ number_format($election->votes->count()) }}
                                          </a>
