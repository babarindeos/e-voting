    ...
    <div class="flex flex-col w-full mx-auto">
        ...
        <section class="flex flex-col w-[90%] md:w-[95%] py-8 px-4 border-red-900 mx-auto">
            ...
            <div class="flex border-b border-gray-300 py-2 justify-between">
                    <div >
                        <h1 class="text-2xl font-semibold font-serif text-gray-800">Delete Election Type</h1>
                    </div> 
                    <div>
                           

                            <a href="{{ route('admin.election_types.index') }}" class="border border-green-600 text-green-600 py-2 px-4 
                ...
                <div>
                    ...
                    @csrf
                        ...
                        <div class="flex flex-col w-[80%] md:w-[60%] py-2 md:py-4" style="font-family:'Lato'; font-size:18px; font-weight:400;">
                            ...
                            Do you really wish to delete this Election Type ?
                            
                            <div class="py-2 text-lg font-semibold">
                                {{ $election_type->name }} ({{ $election_type->coverage == 1 ? 'University' : 'College' }})
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col border-red-900 w-[80%] md:w-[60%] mt-4">
                            <button type="submit" class="border border-1 bg-red-400 py-4 px-4 text-white 
                                           hover:bg-red-500
                                           rounded-md text-lg" style="font-family:'Lato';font-weight:500;">Delete Election Type</button>
                        </div>
