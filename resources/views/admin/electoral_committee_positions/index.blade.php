    ...
    <div class="flex flex-col border-0 w-[95%] mx-auto">
        ...
        <section class="flex flex-col w-full md:w-full py-8 px-2 md:px-4 border-0 border-red-900 mx-auto border border-1">
            ...
            <div class="flex border-b border-gray-300 py-2 justify-between">
                    <div>
                        <h1 class="text-2xl font-semibold font-serif text-gray-800">Electoral Committee Positions</h1>
                    </div>
                    <div>

                            <a href="{{ route('admin.electoral_committees.positions.create') }}" class="bg-green-600 text-white py-2 px-4 
                                            rounded-lg text-xs md:text-sm hover:bg-green-500"><i class="fas fa-plus text-xs"></i> New Electoral Committee Position</a>
                    ...
                    <table class="table-auto border-collapse border border-1 border-gray-200 w-full">
                        <thead>
                            <tr class="bg-gray-200">
                                ...
                                <th width='75%' class="font-semibold py-2 text-left">Position</th>                                                      
                                ...
                                <td>
                                            ...
                                            <span class="text-sm">
                                                <a class="hover:bg-blue-500 bg-blue-400 text-white rounded-md 
                                                        px-4 py-1 text-xs" href="{{ route('admin.electoral_committees.positions.edit', ['position' => $position->id]) }}">Edit</a>
                                            </span>
                                            <span> 
                                                <a class="hover:bg-red-500 bg-red-400 text-white rounded-md 
                                                        px-4 py-1 text-xs" href="{{ route('admin.electoral_committees.positions.confirm_delete', ['position'=> $position->id]) }}"
                                                >Delete</a>
                                            </span>	
            ...
            @else
                    <section class="flex flex-col w-[95%] md:w-[95%] mx-auto px-0 py-8 border-0">
                        <div class="flex flex-row border-0 justify-center text-2xl font-semibold text-gray-300">
                                There is currently no Electoral Committee Positions
                        </div>
                    </section>
            @endif
