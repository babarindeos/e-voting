<x-admin-layout>
    ...
    <div class="flex flex-col border-0 w-[89%] md:w-[93%] mx-auto">
        ...
        <section class="py-8 mt-2">
                <div>
                    <form  action="{{ route('admin.electoral_committees.positions.store') }} " method="POST" enctype="multipart/form-data" class="flex flex-col mx-auto w-full md:w-[95%] items-center justify-center">
                        @csrf
    
                        
    
                        <div class="flex flex-col w-[80%] md:w-[60%] py-2 md:py-4" style="font-family:'Lato'; font-size:18px; font-weight:400;">
                            <h2 class="font-semibold text-xl py-1" >Create Electoral Committee Position</h2>
                        ...
                        <div class="flex flex-col border-red-900 w-[80%] md:w-[60%] mt-4">
                            <button type="submit" class="border border-1 bg-gray-400 py-4 text-white 
                                           hover:bg-gray-500
                                           rounded-md text-lg" style="font-family:'Lato';font-weight:500;">Create Electoral Committee Position</button>
                        </div>
