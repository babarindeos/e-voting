        ...
        <section class="flex flex-col w-full md:w-full py-8 px-2 md:px-4 border-0 border-red-900 mx-auto border border-1">
            ...
            <div class="flex border-b border-gray-300 py-2 justify-between">
                    ...
                    <div>
                            ...
                            <a href="{{ route('admin.papers.create') }}" class="border border-green-600 text-green-600 py-2 px-6 
                                            rounded-lg text-xs md:text-sm hover:bg-green-500 hover:text-white hover:border-green-500">New Paper</a>
                    </div>
            </div>
        </section>
        <!-- end of page header //-->
                                        ...
                                        @endphp
                                                <div>
                                                    ...
                                                    class='text-blue-500 underline font-semibold' >
                                                        <a class="font-semibold text-blue-800 underline" href="{{ route('admin.papers.show',['paper'=>$paper->id]) }}">
                                                            {{ $paper->title }} 
                                                        </a>
                                ...
                                <td>
                                            <span class="px-1">
                                                <a class="bg-green-400 hover:bg-green-500 text-white rounded-md px-4 py-1 text-xs"
                                                    href="{{ route('admin.papers.set_status', ['paper'=> $paper->id]) }}">
                                                    Status
                                                </a>
                                            </span>
                                            <span class="text-sm">
                                                <a class="hover:bg-blue-500 bg-blue-400 text-white rounded-md 
                                                        px-4 py-1 text-xs" href="{{ route('admin.papers.edit', ['paper' => $paper->id]) }}">Edit</a>
                                            </span>
                                            <span> 
                                                <a class="hover:bg-red-500 bg-red-400 text-white rounded-md 
                                                        px-4 py-1 text-xs" href="{{ route('admin.papers.confirm_delete', ['paper'=> $paper->id])}}"
                                                >Delete</a>
                                            </span>	
