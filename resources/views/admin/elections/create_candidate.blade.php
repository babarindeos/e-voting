<x-admin-layout>
    ...
    <div class="flex flex-col border-0 w-[95%] mx-auto">
        ...
        <section class="flex flex-col w-[98%] md:w-[98%] md:flex-row mx-auto py-0 mt-0 border-0 justify-between">   
                ...
                <div>
                        <div class='flex flex-col md:flex-row space-y-1 md:space-y-0 md:space-x-1'>
                                <a href="{{ route('admin.elections.show',['election'=>$election->id]) }}" class="border border-green-600 text-green-600 py-2 px-6 
        ...
        <section class="flex flex-col w-[98%] md:w-[98%] mx-auto py-2 mt-2 border-0">
                    <form  action="{{ route('admin.elections.candidates.store',['election' => $election->id]) }} " method="POST" enctype="multipart/form-data" class="flex flex-col mx-auto w-full md:w-[95%] items-center justify-center">
                                        @csrf
                    
                                        
                    
                                        <div class="flex flex-col w-[80%] md:w-[60%] py-2 md:py-4" style="font-family:'Lato'; font-size:18px; font-weight:400;">
                                            <h2 class="font-semibold text-xl py-1" >New Candidate</h2>
                                                                    ...
                                                                    <select name="position" class="border border-1 border-gray-400 bg-gray-50
                                                                                                            ...
                                                                                                            <option value=''>-- Select Position --</option>
                                                                                                                @foreach($positions as $position)
                                                                                                                    <option class='py-4' value="{{$position->id}}">{{$position->name}}</option>
                                                                                                                @endforeach                                                                    
                                                                                                            </select>
                                        ...
                                        <div class="flex flex-col border-red-900 w-[80%] md:w-[60%] mt-4">
                                            <button type="submit" class="border border-1 bg-gray-400 py-4 text-white 
                                                        hover:bg-gray-500
                                                        rounded-md text-lg" style="font-family:'Lato';font-weight:500;">Create Candidate</button>
                                        </div>
