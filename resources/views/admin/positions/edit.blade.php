<x-admin-layout>
    ...
    <div class="flex flex-col border-0 w-[89%] md:w-[93%] mx-auto">
        ...
        <!-- Create Elective Position Section  //-->
        
       
    
        <section class="py-8 mt-2">
                <div>
                    <form  action="{{ route('admin.positions.update', ['position' => $position->id ]) }} " method="POST" enctype="multipart/form-data" class="flex flex-col mx-auto w-full md:w-[95%] items-center justify-center">
                        @csrf
                        ...
                        <div class="flex flex-col border-red-900 w-[80%] md:w-[60%] mt-4">
                            <button type="submit" class="border border-1 bg-gray-400 py-4 text-white 
                                           hover:bg-gray-500
                                           rounded-md text-lg" style="font-family:'Lato';font-weight:500;">Update Elective Position</button>
                        </div>
                        
                    </form><!-- end of new Elective Position form //-->
                <div>
    
            

        </section>
        <!-- End of Update Elective Position Section //-->
