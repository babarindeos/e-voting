    ...
    <div class="flex flex-col w-full mx-auto">
        ...
        <section class="flex flex-col w-[90%] md:w-[95%] py-8 px-4 border-red-900 mx-auto">
            ...
            <div class="flex border-b border-gray-300 py-2 justify-between">
                    <div >
                        <h1 class="text-2xl font-semibold font-serif text-gray-800">Delete Meeting</h1>
                    </div> 
                    <div>
                            <a href="{{ route('admin.meetings.index') }}" class="bg-green-600 text-white py-2 px-4 
                                            rounded-lg text-xs md:text-sm hover:bg-green-500"> Meetings</a>
                    </div>                       
            </div>
        ...
        <section>
                <div>
                    <form  action="{{ route('admin.meetings.delete', ['meeting' => $meeting->id]) }} " method="POST" class="flex flex-col mx-auto w-[90%] items-center justify-center">
                    @method("delete")    
                    @csrf
